...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=108869&schain=1.0,1!pubgalaxy.com,5699,1&cbuster=1225538215&cbuster=1678176580',
					origQString: 's=108869&schain=1.0,1!pubgalaxy.com,5699,1&cbuster=1225538215',
					placementId: 108869,
					x: 300,
					y: 170,
					videoType: 'normal',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"110.0.0.0","browserVersionMajor":"110","browserVersionMinor":"0","chromeVersion":"110"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":{"0":"en","4":"ko"},"googlePSI":false},
					isFpCookie: 0,
					geo: 'IN',
					dmaCode: 0,
					dynamicSetup: [],
